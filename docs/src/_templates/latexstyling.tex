...
\DeclareUnicodeCharacter{000A9}{\copyright}
...
%\fancyfoot[R]{\ifthenelse{\isodd{\value{page}}}{\tiny Andrea Bocchieri, Lorenzo V. Mugnai, Enzo Pascale (andrea.bocchieri@uniroma1.it)}

%%% Alternating Footer for two side
%\fancyfoot[RO, RE]{\scriptsize Andrea Bocchieri, Lorenzo V. Mugnai, Enzo Pascale (andrea.bocchieri@uniroma1.it)}
